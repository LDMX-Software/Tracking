...
void TrackingGeometryMaker::onProcessStart() {
  ...
  if (dumpobj_) {
    ...
    for (auto& sensor : sensors) {
        ...
        //Rotate Z->X, X->Y, Y->Z 
        Acts::Vector3D position = {transform.translation()[2], transform.translation()[0], transform.translation()[1]};
        ...
        Acts::Vector3D xPos1(cos(rotationAngle), 0., sin(rotationAngle));
        Acts::Vector3D yPos1(0., 1., 0.);
        Acts::Vector3D zPos1(-sin(rotationAngle), 0., cos(rotationAngle));
        ...
        Acts::Vector3D xPos2(1., 0. ,0.);
        Acts::Vector3D yPos2(0., cos(rotationAngle), sin(rotationAngle));
        Acts::Vector3D zPos2(0., -sin(rotationAngle),cos(rotationAngle));
...
void TrackingGeometryMaker::collectSubDetectors_dd4hep(dd4hep::DetElement& detElement,
    ...
    Acts::Transform3D TrackingGeometryMaker::convertTransform(
        ...
        return Acts::TGeoPrimitivesHelper::makeTransform(
            ...
            Acts::Vector3D(translation[0] * Acts::UnitConstants::cm,
